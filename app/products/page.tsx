...
const products = [
  ...
  },
  {
    ...
    slug: "ap-detection",
    description: "Sub-millimeter accuracy for precise aiming point identification in real-time. Works across diverse environments with consistent performance.",
    features: ["Sub-mm precision", "Real-time processing", "Multi-environment support"],
  },
  {
    icon: Box,
  ...
  },
  {
    ...
    description: "Ultra-low latency processing engine delivering sub-millisecond response times for demanding real-time applications.",
    features: ["< 1ms latency", "120+ FPS support", "Edge computing ready"],
  },
  {
    icon: Layers,
    title: "Multi-Object Tracking",
    slug: "multi-object-tracking",
    description: "Simultaneous tracking of multiple objects with unique identification and trajectory prediction capabilities.",
    features: ["Multiple targets", "Object identification", "Trajectory prediction"],
  },
  {
    icon: Shield,
